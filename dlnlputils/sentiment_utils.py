...
# aspect sentiment
PALETTE.set('Comfort-positive',GREEN)
PALETTE.set('Comfort-negative',RED)
PALETTE.set('Comfort-unknown',ORANGE)
PALETTE.set('B-Comfort-positive',GREEN)
PALETTE.set('B-Comfort-negative',RED)
PALETTE.set('B-Comfort-unknown',ORANGE)
PALETTE.set('I-Comfort-positive',GREEN)
PALETTE.set('I-Comfort-negative',RED)
PALETTE.set('I-Comfort-unknown',ORANGE)
PALETTE.set('Appearance-positive',GREEN)
PALETTE.set('Appearance-negative',RED)
PALETTE.set('Appearance-unknown',ORANGE)
PALETTE.set('B-Appearance-positive',GREEN)
PALETTE.set('B-Appearance-negative',RED)
PALETTE.set('B-Appearance-unknown',ORANGE)
PALETTE.set('I-Appearance-positive',GREEN)
PALETTE.set('I-Appearance-negative',RED)
PALETTE.set('I-Appearance-unknown',ORANGE)
PALETTE.set('Reliability-positive',GREEN)
PALETTE.set('Reliability-negative',RED)
PALETTE.set('Reliability-unknown',ORANGE)
PALETTE.set('B-Reliability-positive',GREEN)
PALETTE.set('B-Reliability-negative',RED)
PALETTE.set('B-Reliability-unknown',ORANGE)
PALETTE.set('I-Reliability-positive',GREEN)
PALETTE.set('I-Reliability-negative',RED)
PALETTE.set('I-Reliability-unknown',ORANGE)
PALETTE.set('Safety-positive',GREEN)
PALETTE.set('Safety-negative',RED)
PALETTE.set('Safety-unknown',ORANGE)
PALETTE.set('B-Safety-positive',GREEN)
PALETTE.set('B-Safety-negative',RED)
PALETTE.set('B-Safety-unknown',ORANGE)
PALETTE.set('I-Safety-positive',GREEN)
PALETTE.set('I-Safety-negative',RED)
PALETTE.set('I-Safety-unknown',ORANGE)
PALETTE.set('Driveability-positive',GREEN)
PALETTE.set('Driveability-negative',RED)
PALETTE.set('Driveability-unknown',ORANGE)
PALETTE.set('B-Driveability-positive',GREEN)
PALETTE.set('B-Driveability-negative',RED)
PALETTE.set('B-Driveability-unknown',ORANGE)
PALETTE.set('I-Driveability-positive',GREEN)
PALETTE.set('I-Driveability-negative',RED)
PALETTE.set('I-Driveability-unknown',ORANGE)
PALETTE.set('Whole-positive',GREEN)
PALETTE.set('Whole-negative',RED)
PALETTE.set('Whole-unknown',ORANGE)
PALETTE.set('B-Whole-positive',GREEN)
PALETTE.set('B-Whole-negative',RED)
PALETTE.set('B-Whole-unknown',ORANGE)
PALETTE.set('I-Whole-positive',GREEN)
PALETTE.set('I-Whole-negative',RED)
PALETTE.set('I-Whole-unknown',ORANGE)
PALETTE.set('Costs-positive',GREEN)
PALETTE.set('Costs-negative',RED)
PALETTE.set('Costs-unknown',ORANGE)
PALETTE.set('B-Costs-positive',GREEN)
PALETTE.set('B-Costs-negative',RED)
PALETTE.set('B-Costs-unknown',ORANGE)
PALETTE.set('I-Costs-positive',GREEN)
PALETTE.set('I-Costs-negative',RED)
PALETTE.set('I-Costs-unknown',ORANGE)
PALETTE.set('other-unknown', BROWN)
PALETTE.set('Other-unknown', BROWN)
...
def generate_markup(tokens,tags):
    mapper = lambda tag: tag[2:] if tag!='Other-unknown' else tag
...
def fill_gaps(text, source_spans):
    ...
    for span in source_spans:
        s,e,t = span
        if text_pos<s:
            chunks.append((text_pos,s,'Other-unknown'))
        chunks.append((s,e,t))
        text_pos=e
            
    if text_pos<len(text)-1:
        chunks.append((text_pos,len(text),'Other-unknown'))
...
def get_aspect_sentiment_spans(root):
    ((start, end, aspect_tag), (_,_,sentiment_tag)) = (get_tag_spans(root,'category'), get_tag_spans(root,'sentiment'))
    return start, end, aspect_tag + '-' + sentiment_tag
...
def parse_xml_aspect_sentiment(xml_file): return parseXML(xml_file, get_aspect_sentiment_spans)
